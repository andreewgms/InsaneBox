...
<html>
    ...
    <body class="text-center">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a href="Cadastro_usuario.php" id="Cadastro_usr">Cadastrar Usuário</a>
            <div class="dropdown">
            ...
            <div class="dropdown">
                <button class="dropbtn">Validar 
                    <i class="fa fa-caret-down"></i>
                </button>
                <div class="dropdown-content">
                    <a href="Doacao.php" id="doacao">Valida Doação</a>
                    <a href="Projeto.php" id="projeto">Valida Projeto</a>
                    <a href="Participacao.php" id="participacao">Valida Participação</a>
                </div>
            </div> 
