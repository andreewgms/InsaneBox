...
<html>
    ...
    <body class="text-center">
        ...
        <div class="topnav" id="myTopnav">
            <a href="Contribuicoes.php" id="Contribuicao" class="active">Visualizar Contribuições</a>
        ...
        ">
            <div class="col col-md-12 bg-dark text-center" style="color: White;">
                ...
                <div class="row">
                    <div id="form-contribuicao" class="form-user"><!-- <div class="row"> -->
                        <form method="post" action="valida_participacao.php">
                            <div class="row">
                                <h1>Contribuicoes do Usuario </h1><p><?php echo $_SESSION['colete']?></p>
                            </div>
                            <div class="row">
                                <h2>Não há contribuições cadastradas ainda, atualizando o sistema %\/%</h2>
                            </div>
                        </form>
                    </div>
                </div>
