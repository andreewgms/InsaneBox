...
<html>
    ...
    <body class="text-center">
        ...
        <div class="topnav" id="myTopnav">
            <a href="Doacao.php" id="doacao" class="active">Doação</a>
        ...
        ">
            <div class="col col-md-12 bg-dark text-center" style="color: White;">
                ...
                <div id="form-doacao" class="form-user" ><!-- <div class="row"> -->
                    <form method="post" action="valida_doacao.php"><!-- valida_doacao.php -->
                        <div class="row">
                            <h1>FormulariO de DoacaO</h1>
                        </div>
                        <div class="row">
                            <label for="valor" class="col-3"><p>Valor:</p></label>
                            <input type="number" class="col-8" name="valor" min="10" max="1000" placeholder="Informe o valor" required><br>
                        </div>
                        <div class="row">
                        ...
                        <button type="submit" name="" class="btn btn-primary col-4 col-sm-6" value="Enviar Doacao" onclick="validadoacao()" >Enviar</button><a href="User-mem.php" class="btn btn-danger col-4 col-sm-6">Retornar</a>
                    </form>
                </div>
            </div>
        </div>
