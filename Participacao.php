            ...
            <div class="col col-md-12 bg-dark text-center" style="color: White;">
                ...
                <div id="form-doacao" class="form-user" ><!-- <div class="row"> -->
                    <form method="post" action="#"><!-- valida_doacao.php -->
                        <div class="row">
                            <h1>ValidaR Particip. em ProjetO</h1>
                        </div>
                        <div class="row">
                            <label for="ID" class="col-3"><p>Id do Projeto:</p></label>
                            <input type="number" id="ID" class="col-8" name="Descricao" placeholder="Informe o nome do projeto" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input type="textarea" id="Ajudante" class="col-8" name="Descricao" placeholder="Informe a ID de ajudantes (se houver)" required>
                        </div>
